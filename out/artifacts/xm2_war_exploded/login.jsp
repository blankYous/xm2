...
<title>Blank. Yours潮流鞋登录注册表单界面</title>
<link rel="stylesheet" type="text/css" href="css/login.css">
</head>
<body style="background: url('images/timg.gif');background-repeat:no-repeat; background-size: 100%      ">
	...
	function check_login()
	{
	 ...
	 if(name=="admin" && pass=="admin")
	 {
	  alert("登录成功！");
         $("#user_name").val("");
	  $("#password").val("");
       $(location).attr('href', 'index.jsp?name='+name);
	 }
	 else
	 {
