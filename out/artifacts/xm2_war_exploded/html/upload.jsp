                ...
                success:function (data) {
                    ...
                    if (data.length>0){
                        ...
                        $(".layui-unselect").not(".header").click(function () {  //单击选择
                            if (a%2==0){
                                var index=$(".layui-unselect").index(this);

                                if ($(".layui-unselect:eq("+index+")").attr("class")=="layui-unselect layui-form-checkbox layui-form-checked") {
                                    $(".layui-unselect:eq("+index+")").not(".header").attr("class","layui-unselect layui-form-checkbox")
                                }else {

                                    $(".layui-unselect:eq("+index+")").not(".header").attr("class","layui-unselect layui-form-checkbox layui-form-checked")

                                }
                            } else {
                                var index=$(".layui-unselect").index(this);
                                if ($(".layui-unselect:eq("+index+")").attr("class")=="layui-unselect layui-form-checkbox layui-form-checked") {
                                    $(".layui-unselect:eq("+index+")").attr("class","layui-unselect layui-form-checkbox")
                                }else {
                                    $(".layui-unselect:eq("+index+")").attr("class","layui-unselect layui-form-checkbox layui-form-checked")
                                ...
                                $.ajax({
                                    ...
                                    success:function (data) {
                                        ...
                                        if (name=="全部"||name=="已售罄") {
                                            ...
                                            var a=$("#count").text();
                                            $("#count").html(a-1)
                                            window.location.reload();//删除后分页有误 所以刷新
                                        }
                                    }
                                })
                            } else if (title=="上架"){
...
<table class="layui-table" id="t_student">
    ...
    <tr class="spu">
        ...
        <td class="td-manage">
            <a href="javascript:void(0);" class="button-status" title="">
                <i class="sj"></i> <%--arrow-circle-down下架--%>
            </a>
            <a title="编辑"  class="update" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
            </a>
