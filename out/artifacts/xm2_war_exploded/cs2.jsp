...
<table align="center" style="background-color: rgba(236,236,242,0.76)">
    <tr style="width: 1200px">
        ...
        <td style="border: 1px lightgrey solid; ">
            ...
            <div style="background-color: rgba(236,236,242,0.76);height: 60px;width: 1090px;margin-left: 110px">
                ...
                <div style="float: left;margin-top: 15px;font-size: 30px">————></div>
                <div style="height: 45px; width: 200px;background-color: rgba(236,236,242,0.76);margin-top: 10px;float: left">
                ...
                <%--商品基本信息--%>
            <div style="width: 1000px;margin-top: 20px;display: none" id="jbxx">
                <table align="center">
                    ...
                    <tr style="height: 30px">
                        ...
                        <td>
                            <input type="radio" name="sex" value="男子">男子
                    ...
                    <tr style="height: 30px">
                            <td colspan="2"><input style="margin-left: 750px;height: 30px;width: 100px" id="next" type="button" value="下一步"></td>
                    </tr>
                </table>
            </div>
                </form>
    ...
    &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input type="checkbox" value="黑白条纹"style="margin-left: 30px;display:inline-block"class="color" disabled>黑白条纹<br>
                        ...
                        <tr >
                            <td colspan="3" style=""><input style="margin-left: 650px ;width: 100px;height: 30px" id="tj" type="button" value="提交"></td>
                        </tr>
           ...
           <%-- 添加成功--%>
            <div style="width: 1000px;margin-top: 20px;height: 500px;margin-left: 100px;">
                ...
                <p style="padding-top: 100px"><a href="selectPutaway"style="font-size: 20px;margin-left: 820px;">返回商品列表</a></p>
            </div>
        </td>
    </tr>
</table>
...
<script type="text/javascript">
    $(function () {
        ...
        var brand=["--请选择--","adidas","耐克","彪马","亚瑟士","匡威","斯凯奇","新百伦","网球鞋","李宁","卡米"];
        brand["--请选择--"]=["--请选择--"];
